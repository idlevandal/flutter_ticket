...
class DiscountTicket extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        CustomPaint(
          size: Size(screenWidth, (screenWidth*0.47 - 20).toDouble()), //You can Replace [WIDTH] with your desired width for Custom Paint and height will be calculated automatically
